...
#region private void
		...
		{
			//в данном случае тебе не нужны анонимные методы делать
			//ты можешь так записывать types.Add(TypeGlowing.Score, GlowScore);
			//почитай информацию за method group - я тебя потом об этом спрошу
