...
#region public void
		...
		{
			var findedObj
				= listEnemies.FirstOrDefault(x => x.EnemyStats.enemyType == enemyType && !x.gameObject.activeInHierarchy);
			if (findedObj == null)
			{
		...
		//СКОБКИ, БЛЯХА
		//у тебя два варика, или делай через свойство, или ставь скобки
		//Пройдись по всему коду и переделай
