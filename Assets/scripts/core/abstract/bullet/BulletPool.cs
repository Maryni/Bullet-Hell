...
#pragma warning disable
		...
		[SerializeField] private AutomaticalBullet automaticalBulletPrefab; //нейминг
		[SerializeField] private ShotgunBullet shotgunBulletPrefab;
		[SerializeField] private RocketLaucherBullet rocketLaucherBulletPrefab; //нейминг
...
#region private void
		...
		{
			//выведи значение "20" в сериализированную филду
			for (int i = 0; i < 20; i++)
			{
