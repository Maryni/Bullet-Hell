...
#pragma warning disable
		...
		[SerializeField] private SmoothPause smoothPause; // зачем ты сериализируешь переменную, если ты ее ищешь через в старте?
...
#region public void
		...
		{
			//здесь ты ищешь нужную оружку, но нигде не используешь в игроке
